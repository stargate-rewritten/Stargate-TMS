...
if not path.exists(Directory.COMPILE_BUNGEE.value):
    os.makedirs(Directory.COMPILE_BUNGEE.value)
...
shutil.copy(path.join(Directory.COMPILE_BUNGEE.value, "proxy.jar"), path.join(Directory.RUNTIME_COMPAT_BUNGEE.value, "proxy.jar"))
...
if not path.exists(Directory.RUNTIME_NETWORK_WATERFALL.value):
    os.makedirs(Directory.RUNTIME_NETWORK_WATERFALL.value)
